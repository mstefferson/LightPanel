...
class AudioReactiveBassPattern(PanelPattern):
    def __init__(self, m, n):
        ...
        self.volumeFilter   = music.ExpFilter(0.1, alpha_rise=0.05, alpha_decay=0.05)
        self.spectrumFilter = music.ExpFilter(np.zeros_like(self.stream.notes), alpha_rise=0.5, alpha_decay=0.1)
